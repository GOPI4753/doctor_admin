...
<head>
    ...
    <script src="<?php echo $home_url ?>/assets/js/v1.5_cdn.js"></script>
    <script src="<?php echo $home_url ?>/assets/js/imagemapster.js"></script>
...
<body>
    ...
    <div>
        <img src="<?php echo $home_url ?>/assets/images/mouth.jpeg" usemap="#usa" style="width: 400px;height: auto;">
        <img src="<?php echo $home_url ?>/assets/images/teeths.jpeg" usemap="#bsa" style="width:400px;height: auto;">
    </div>
    ...
    <div>
        <h4>Marked Teeth with problem </h4>
        <table class="table">
            <thead>
                <tr>
    ...
    <script>
        ...
        LIST.forEach(element => {
            teethdata_map.forEach(list => {
                if (list.number == element.id) {
                    console.log("teeth number: ", list.teeth, "Probelm", element.name);
                    var b = $('<tr><th scope="row">' + list.teeth + '</th><td>' + element.name + '</td></tr>');
                    $('#teethData').append(b);
                    b.attr('id', element.id);
                }
            })
        })
